...
//
// Coverage: KDP/HTC/JHS/BH4/LP for all 24 months of both FYs; GB from Sep
...
//
// 2026-09-21 (later) — LP ADDED, correcting the previous version of this
// file, which had excluded LP under the assumption its existing
// lpMonthly.ts-sourced numbers already matched. They don't always: this
// gap is exactly what caused July 2024's overall Occupancy to read 83.4%
// instead of the workbook's 86.2% (LP's live figure differed enough from
// the workbook's to move the blended total) — both workbooks in fact have
// full LP rows, same as every other property, so LP is covered the same
// way now.
//
// GB's availableRoomNights for FY24-25 uses a room count of 15, not the
// 21 rooms propertyReference.ts has for GB today — confirmed via implied
// Available = Sold/Occupancy for every FY24-25 month (e.g. Jul 2024: 442
// sold / 0.9505 occupancy = 465 = 15x31): GB genuinely expanded from 15 to
// 21 rooms at some point between FY24-25 and FY25-26 (FY25-26's own sheet
// directly gives GB 651 = 21x31 for a full month). Every other property's
// implied room count stays constant at its current propertyReference.ts
// value across both FYs.
//
...
export const HISTORICAL_MONTHLY_DATA: Record<string, HistoricalMonthData> = {
  ...
  "LP|2025-04": { soldRoomNights: 354, availableRoomNights: 480, revenue: 1297129 },
  ...
  "LP|2025-05": { soldRoomNights: 228, availableRoomNights: 496, revenue: 821240 },
  ...
  "LP|2025-06": { soldRoomNights: 306, availableRoomNights: 480, revenue: 1153465 },
  ...
  "LP|2025-07": { soldRoomNights: 355, availableRoomNights: 496, revenue: 1375281 },
  ...
  "LP|2025-08": { soldRoomNights: 287, availableRoomNights: 496, revenue: 1062457 },
  ...
  "LP|2025-09": { soldRoomNights: 368, availableRoomNights: 480, revenue: 1453850 },
  ...
  "LP|2025-10": { soldRoomNights: 212, availableRoomNights: 496, revenue: 802498 },
  ...
  "LP|2025-11": { soldRoomNights: 410, availableRoomNights: 480, revenue: 1834227 },
  ...
  "LP|2025-12": { soldRoomNights: 317, availableRoomNights: 496, revenue: 1436589 },
  ...
  "LP|2026-01": { soldRoomNights: 387, availableRoomNights: 496, revenue: 1598221 },
  ...
  "LP|2026-02": { soldRoomNights: 325, availableRoomNights: 448, revenue: 1455059 },
  ...
  "LP|2026-03": { soldRoomNights: 259, availableRoomNights: 496, revenue: 1058131 },
  ...
  "GB|2024-04": { soldRoomNights: 258, availableRoomNights: 450, revenue: 728435, b2bRevenue: 596151, b2cRevenue: 132284 },
  "LP|2024-04": { soldRoomNights: 311, availableRoomNights: 480, revenue: 1087023, b2bRevenue: 356425, b2cRevenue: 730598 },
  ...
  "GB|2024-05": { soldRoomNights: 344, availableRoomNights: 465, revenue: 961770, b2bRevenue: 797582, b2cRevenue: 164188 },
  "LP|2024-05": { soldRoomNights: 301, availableRoomNights: 496, revenue: 1086881, b2bRevenue: 155800, b2cRevenue: 931081 },
  ...
  "GB|2024-06": { soldRoomNights: 350, availableRoomNights: 450, revenue: 1056500, b2bRevenue: 633750, b2cRevenue: 422750 },
  "LP|2024-06": { soldRoomNights: 373, availableRoomNights: 480, revenue: 1426061, b2bRevenue: 168500, b2cRevenue: 1257561 },
  ...
  "GB|2024-07": { soldRoomNights: 442, availableRoomNights: 465, revenue: 1426850, b2bRevenue: 544600, b2cRevenue: 882250 },
  "LP|2024-07": { soldRoomNights: 446, availableRoomNights: 496, revenue: 1751750, b2bRevenue: 178300, b2cRevenue: 1573450 },
  ...
  "GB|2024-08": { soldRoomNights: 434, availableRoomNights: 465, revenue: 1413961, b2bRevenue: 548500, b2cRevenue: 865461 },
  "LP|2024-08": { soldRoomNights: 397, availableRoomNights: 496, revenue: 1566385, b2bRevenue: 38150, b2cRevenue: 1528235 },
  ...
  "GB|2024-09": { soldRoomNights: 400, availableRoomNights: 450, revenue: 1327900, b2bRevenue: 312900, b2cRevenue: 1015000 },
  "LP|2024-09": { soldRoomNights: 255, availableRoomNights: 480, revenue: 975186, b2bRevenue: 144300, b2cRevenue: 830886 },
  ...
  "GB|2024-10": { soldRoomNights: 435, availableRoomNights: 465, revenue: 1372700, b2bRevenue: 455700, b2cRevenue: 917000 },
  "LP|2024-10": { soldRoomNights: 397, availableRoomNights: 496, revenue: 1529978, b2bRevenue: 734850, b2cRevenue: 795128 },
  ...
  "GB|2024-11": { soldRoomNights: 401, availableRoomNights: 450, revenue: 1237255, b2bRevenue: 497600, b2cRevenue: 739655 },
  "LP|2024-11": { soldRoomNights: 427, availableRoomNights: 480, revenue: 1914345, b2bRevenue: 600800, b2cRevenue: 1313545 },
  ...
  "GB|2024-12": { soldRoomNights: 418, availableRoomNights: 465, revenue: 1297145, b2bRevenue: 547550, b2cRevenue: 749595 },
  "LP|2024-12": { soldRoomNights: 418, availableRoomNights: 496, revenue: 1888724, b2bRevenue: 172750, b2cRevenue: 1715974 },
  ...
  "GB|2025-01": { soldRoomNights: 7, availableRoomNights: 465, revenue: 17500, b2bRevenue: 17500, b2cRevenue: 0 },
  "LP|2025-01": { soldRoomNights: 387, availableRoomNights: 496, revenue: 1502765, b2bRevenue: 261100, b2cRevenue: 1241665 },
  ...
  "LP|2025-02": { soldRoomNights: 355, availableRoomNights: 448, revenue: 1343639, b2bRevenue: 79000, b2cRevenue: 1264639 },
  ...
  "LP|2025-03": { soldRoomNights: 325, availableRoomNights: 496, revenue: 1253700, b2bRevenue: 110350, b2cRevenue: 1143350 },
};

...
// product tier "Premiere Supreme", NOT "Executive Room" (which they were all
// mapped to). "Executive Room" stays reserved for the Aptly brand (BH4/GB) —
// which currently has nothing mapped to it, so the type is retained in the
// lists below but won't appear in charts until Aptly data uses it. Also
// 2026-09-10: "Banquet" removed as a room type — a banquet hall isn't a
// sellable room; its 56 KDP rows are now filtered out of room-format
// breakdowns (see getRoomFormatStats) rather than mapped.
...
const KDP: [string, string][] = [
  ["101 old-Premier King Supreme", "Premiere Supreme"],
  ["101-Premier Twin Supreme", "Premiere Supreme"],
  ["102-Premier King Supreme", "Premiere Supreme"],
  ["103-Premier King Supreme", "Premiere Supreme"],
  ["104-Premier King Supreme", "Premiere Supreme"],
  ["105-Premier King Supreme", "Premiere Supreme"],
  ["106-Premier King Supreme", "Premiere Supreme"],
  ...
  ["201 old-Premier King Supreme", "Premiere Supreme"],
  ["201-Premier Twin Supreme", "Premiere Supreme"],
  ["202-Premier King Supreme", "Premiere Supreme"],
  ["203-Premier King Supreme", "Premiere Supreme"],
  ["204-Premier King Supreme", "Premiere Supreme"],
  ["205-Premier King Supreme", "Premiere Supreme"],
  ["206-Premier King Supreme", "Premiere Supreme"],
  ...
  ["301 old-Premier King Supreme", "Premiere Supreme"],
  ["301-Premier Twin Supreme", "Premiere Supreme"],
  ["302-Premier King Supreme", "Premiere Supreme"],
  ["303-Premier King Supreme", "Premiere Supreme"],
  ["304-Premier King Supreme", "Premiere Supreme"],
  ["305-Premier King Supreme", "Premiere Supreme"],
  ["306-Premier King Supreme", "Premiere Supreme"],
  ...
  ["401 old-Premier King Supreme", "Premiere Supreme"],
  ["401-Premier Twin Supreme", "Premiere Supreme"],
  ["402-Premier King Supreme", "Premiere Supreme"],
  ["403-Premier King Supreme", "Premiere Supreme"],
  ["404-Premier King Supreme", "Premiere Supreme"],
  ["405-Premier King Supreme", "Premiere Supreme"],
  ["406-Premier King Supreme", "Premiere Supreme"],
  ...
  ["Premier King Supreme", "Premiere Supreme"],
  ["Premier Twin Supreme", "Premiere Supreme"],
];

const HTC: [string, string][] = [
  ["11-Premier King Supreme", "Premiere Supreme"],
  ["12-Premier Twin Supreme", "Premiere Supreme"],
  ["14-Studio Supreme", "Studio Room"],
  ["15-Premier Twin Supreme", "Premiere Supreme"],
  ["16-Premier King Supreme", "Premiere Supreme"],
  ["17-One Bedroom Suite", "1 BHK"],
  ["21-Premier King Supreme", "Premiere Supreme"],
  ["22-Premier Twin Supreme", "Premiere Supreme"],
  ["23-Studio Supreme", "Studio Room"],
  ["24-Premier Twin Supreme", "Premiere Supreme"],
  ["25-Premier King Supreme", "Premiere Supreme"],
  ["26-One Bedroom Suite", "1 BHK"],
  ["31-Premier King Supreme", "Premiere Supreme"],
  ["32-Premier Twin Supreme", "Premiere Supreme"],
  ["33-Studio Supreme", "Studio Room"],
  ["34-Premier Twin Supreme", "Premiere Supreme"],
  ["35-Premier King Supreme", "Premiere Supreme"],
  ["36-One Bedroom Suite", "1 BHK"],
  ["41-Premier King Supreme", "Premiere Supreme"],
  ["42-Premier Twin Supreme", "Premiere Supreme"],
  ["43-Studio Supreme", "Studio Room"],
  ["44-Premier Twin Supreme", "Premiere Supreme"],
  ["45-Premier King Supreme", "Premiere Supreme"],
  ["46-One Bedroom Suite", "1 BHK"],
  ["51-Premier King Supreme", "Premiere Supreme"],
  ["52-Premier Twin Supreme", "Premiere Supreme"],
  ["53-Studio Supreme", "Studio Room"],
  ["54-Premier Twin Supreme", "Premiere Supreme"],
  ["55-Premier King Supreme", "Premiere Supreme"],
  ["56-One Bedroom Suite", "1 BHK"],
  ["61-Premier King Supreme", "Premiere Supreme"],
  ["62-Premier Twin Supreme", "Premiere Supreme"],
  ["63-One Bedroom Suite Supreme", "1 BHK"],
  ["64-Premier King Supreme", "Premiere Supreme"],
];

const JHS: [string, string][] = [
  ["100 - 2 BHK Studio-Two Bedroom Suite", "2 BHK"],
  ["101-Premier Room", "Premiere Supreme"],
  ...
  ["110-Premier Room", "Premiere Supreme"],
  ["111-Premier Room", "Premiere Supreme"],
  ["200 - 2 BHK Studio-Two Bedroom Suite", "2 BHK"],
  ["201-Premier Room", "Premiere Supreme"],
  ...
  ["210-Premier Room", "Premiere Supreme"],
  ["211-Premier Room", "Premiere Supreme"],
  ["300 - 2BHK Studio-Two Bedroom Suite", "2 BHK"],
  ["301-Premier Room", "Premiere Supreme"],
  ...
  ["310-Premier Room", "Premiere Supreme"],
  ["311-Premier Room", "Premiere Supreme"],
  ["Premier Room", "Premiere Supreme"],
